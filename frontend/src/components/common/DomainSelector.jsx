          ...
          {domains.map((domain, idx) => (
            <Link key={idx} to={domain.path} className="block group">
              <motion.div
                ...
                className="relative overflow-hidden rounded-xl border border-gray-100 shadow-lg bg-white p-6 h-full flex flex-col items-center text-center hover:shadow-xl transition-all duration-150"
              >
