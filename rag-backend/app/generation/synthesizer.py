...
def _select_response_mode(complexity: float) -> tuple:
    ...
    brief    (< BRIEF_RESPONSE_THRESHOLD)    → Quick Take + KE + DA,  ~2000 tokens
    standard (< STANDARD_RESPONSE_THRESHOLD) → Quick Take + KE + DA,  ~3500 tokens
    detailed (>= STANDARD_RESPONSE_THRESHOLD)→ Quick Take + KE + DA, ~5000 tokens
    """
